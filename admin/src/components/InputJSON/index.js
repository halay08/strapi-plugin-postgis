...
const loadCss = async () => {
  ...
  await import(
    /* webpackChunkName: "codemirror-addon-lint" */ "codemirror/addon/lint/lint"
  );
  await import(
  ...
  await import(
    /* webpackChunkName: "codemirror-css" */ "codemirror/lib/codemirror.css"
  );
  await import(
    /* webpackChunkName: "codemirror-theme" */ "codemirror/theme/blackboard.css"
  );
};
